...
var sheng=[
 ...
 var shi=[{"item_code":"110100","item_name":"北京市"},
 ...
 var xian=[{"item_code":"110101","item_name":"东城区"},
...
for(var i=0;i<sheng.length;i++){
    t=new Option(sheng[i].item_name,sheng[i].item_code.substring(0,2));
    shengs.appendChild(t);
}
...
shengs.onchange=function(){
    while(shis.children[1]){
        shis.removeChild(shis.children[1]);
    }
    while(xians.children[1]){
        xians.removeChild(xians.children[1]);
    }
    for(var i=0;i<shi.length;i++){
        if(this.value===shi[i].item_code.substring(0,2)){
            t=new Option(shi[i].item_name,shi[i].item_code.substring(0,4));
            shis.appendChild(t);
        }
    }
}

shis.onchange=function(){
    while(xians.children[1]){
        xians.removeChild(xians.children[1]);
    }
    for(var i=0;i<xian.length;i++){
        if(this.value===xian[i].item_code.substring(0,4)){
            t=new Option(xian[i].item_name,xian[i].item_code);
            xians.appendChild(t);
        }
    }
}
